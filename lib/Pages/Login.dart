  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        ...
        children: [
          Image.network(
            'https://d33wubrfki0l68.cloudfront.net/8d79b89491cf9ef958be1386776dc937d39266be/1a630/img/particle_background.jpg', // Replace with the URL or path to your image
            fit: BoxFit.cover,
          ),
