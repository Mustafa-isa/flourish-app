...
// ContactPage()
              Row(
                ...
                children: <Widget>[
                  Visibility(
                    visible:
                        "https://www.reuters.com/?edition-redirect=ara" != null,
                    child: IconButton(
                      color: Colors.teal,
                      onPressed: () {
                        launchUrl(Uri.parse(
                            "https://www.reuters.com/?edition-redirect=ara"!));
                      },
                      icon: Icon(Typicons.link),
                    ),
                  ),
                  Visibility(
                      visible: 01030039850 != null,
                      child: IconButton(
                  ...
                  Visibility(
                      child: IconButton(
                          ...
                          onPressed: () {
                            launchUrl(
                                Uri.parse('mailto:' + "doaahamdy11122@gmail.com"));
                          },
                          icon: Icon(Typicons.mail))),
                  Visibility(
                    visible: "profile.php?id=100063716215592&mibextid=ZbWKwL" !=
                        null,
                    child: IconButton(
                        color: Colors.blueAccent,
                        onPressed: () {
                          launchUrl(Uri.parse(
                              'https://www.facebook.com/profile.php?id=100063716215592&mibextid=ZbWKwL'));
                        },
      ...
      return AlertDialog(
        ...
        content: Container(
          child: Column(
            ...
            children: [
              InkWell(
                onTap: () => launchUrl(Uri.parse('tel:' + "01030039850"!)),
                child: Container(
                  height: 50.0,
              ...
              Divider(),
              InkWell(
                onTap: () => launchUrl(Uri.parse('sms:' + "01030039850"!)),
                child: Container(
                  alignment: Alignment.center,
                  height: 50.0,
                  child: Text('Message'),
